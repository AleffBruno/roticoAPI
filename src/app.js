...
var _a = authConfig_1.default.jwt, secret = _a.secret, expiresIn = _a.expiresIn;
...
typeorm_1.createConnection().then(function (connection) {
    ...
    app.get("/addrops", function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                res.json({ ok: "addrops" });
                return [2 /*return*/];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        user = _b.sent();
                        if (!user) {
                            return [2 /*return*/, res.json({ msg: "Credenciais erradas" })];
                        }
